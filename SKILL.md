---
name: clipcat
description: Clipcat - TikTok e-commerce video creation skill. Video analysis, viral replication, product-to-video generation, and video download via Clipcat.ai API.
user-invocable: true
metadata:
  {
    "openclaw":
